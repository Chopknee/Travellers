...
public class DungeonManager_old: MonoBehaviour {

    public static DungeonManager_old CurrentInstance { get; private set; }
...
#pragma warning disable 0649
    ...
    private class Branch {
        ...
        private DungeonManager_old dm;
        float lastDirection = 0;
        int seedNumber = 0;

        Vector2 startPosition;

        public Branch(PathfindingGrid pathfinder, Vector2 start, DungeonManager_old dm, bool isMainBranch, float deathChance, int maxNodes, int seedNumber, float startDirection) {
